...
import { Avatar, LinkBlock, MainLayout, VideoBlock } from "../components";
    ...
    <MainLayout>
      <div className="max-w-[25rem] mx-auto">
        <div className="flex flex-col items-center text-center">
          ...
          {creator.bio && (
            <div className="mt-0.5 text-gray-600 leading-5">{creator.bio}</div>
          )}
        </div>
        ...
        <Link href="/"><a className="mt-12 inline-block text-primary-500">&#8592; Home</a></Link>
      </div>
    </MainLayout>
  );
};
