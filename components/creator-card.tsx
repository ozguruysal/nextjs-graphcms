...
export const CreatorCard: FunctionComponent<Props> = ({ creator }) => {
  return (
    <a
      ...
      className="p-6 flex flex-col items-center border hover:border-neutral-300 hover:shadow-sm rounded"
    >
      {creator.avatar && (
      ...
      <div className="mt-0.5 text-neutral-600">@{creator.username}</div>
    </a>
  );
};
